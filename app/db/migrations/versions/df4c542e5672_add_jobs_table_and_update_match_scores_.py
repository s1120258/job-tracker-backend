...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "match_scores_application_id_key", "match_scores", type_="unique"
    )
    op.create_unique_constraint(None, "match_scores", ["job_id"])
    op.drop_constraint(
        "match_scores_application_id_fkey", "match_scores", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "match_scores_application_id_fkey",
        "match_scores",
        "applications",
        ["application_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        "match_scores_application_id_key", "match_scores", ["application_id"]
    )
