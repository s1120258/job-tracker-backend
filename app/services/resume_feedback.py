...
def get_job_specific_feedback(extracted_text: str, application_id: UUID) -> Tuple[List[str], str]:
    """
    ...
    if not extracted_text or len(extracted_text.strip()) == 0:
        return (["Resume text is empty. Please upload a valid resume."], job_description_excerpt)
    # Replace this with an LLM API call, etc.
    return (
        [
